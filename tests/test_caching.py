...
from scripts.file_reading_funcs import get_validated_security_data, read_series_data, pickle_securities_objects, \
...
def test_caching_large(symbols_list: list, source: str):
    ...
    for symbol in tqdm(symbols_list, desc="Caching results"):
        get_validated_security_data(symbol, '2022', '2023-06-02', source, dl_data=False, use_ch=False)
    ...
    get_validated_security_data(test_symbol, '2022', '2023-06-02', source, dl_data=False, use_ch=False)
